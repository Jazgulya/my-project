      ...
      {showInvoice ? (
        <>
          ...
          <Box>
            ...
            {/* End of Footer */}
            <Button onClick={() => setShowInvoice(false)} variant="outlined"> Edit information</Button>
          </Box>
        </>
      ) : (
        ...
        <Box display="flex" flexDirection="column" justifyContent="center">
          <TextField
            ...
            autoComplete="off"
          />
          <Button onClick={() => setShowInvoice(true)} style={{ backgroundColor: "green", color: "white", fontWeight: "bold", paddingX: "8px", paddingY: "2px" }}>Preview invoice</Button>
        </Box >
      )
      }
    </Container>
